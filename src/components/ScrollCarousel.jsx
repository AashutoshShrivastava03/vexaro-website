...
const SLIDES = [
  {
    ...
    bgGradient:
      "linear-gradient(135deg, #FAFBFF 0%, #EEF2FF 50%, #F0F4FF 100%)",
    accentColor: "#1A3A8F",
  ...
  },
  {
    ...
    bgGradient:
      "linear-gradient(135deg, #EEF2FF 0%, #E8EEFF 40%, #FFF4ED 100%)",
    accentColor: "#E06000",
  ...
  },
  {
    ...
    bgGradient:
      "linear-gradient(135deg, #F5EDD0 0%, #EDD89A 35%, #E8C84A 70%, #1A3A8F 100%)",
    accentColor: "#B84D00",
    tagBg: "bg-navy-50 border-navy/20",
    tagText: "text-navy",
    dotColor: "#B84D00",
  ...
  },
  {
    ...
    bgGradient:
      "linear-gradient(135deg, #F0F4FF 0%, #EEF2FF 40%, #FAFBFF 100%)",
    accentColor: "#1A3A8F",
    tagBg: "bg-navy-50 border-navy/20",
    tagText: "text-navy",
    dotColor: "#1A3A8F",
    ...
    return (
      <div className="relative w-full h-full flex items-center justify-center">
        <div className="w-72 md:w-80 bg-white rounded-2xl shadow-lg border border-blue-100 p-6">
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold font-heading text-charcoal text-sm">
                Live Dispatch
              </span>
            </div>
            <span className="text-xs font-body bg-green-50 text-green-600 px-2 py-1 rounded-full border border-green-200 font-medium">
              ● Active
            </span>
          </div>
          {[
            ...
            <div key={i} className="mb-4 last:mb-0">
              <div className="flex justify-between items-center mb-1.5">
                <span className="text-xs font-heading text-charcoal font-medium">
                  {r.route}
                </span>
                <span className="text-[11px] font-body text-graphite">
                  {r.status}
                </span>
              </div>
          ...
          <div className="mt-5 pt-4 border-t border-blue-100 flex gap-3">
            {[
              ...
              <div
                key={l}
                className="flex-1 bg-blue-50 border border-blue-100 rounded-lg py-2 text-center"
              >
                <div className="text-navy font-bold font-heading text-sm">
                  {v}
                </div>
        ...
        >
          ...
          <span className="text-charcoal text-xs font-heading font-semibold">
            Express
          </span>
        </motion.div>
      </div>
        ...
        <div className="w-72 md:w-80 bg-white rounded-2xl shadow-lg border border-blue-100 p-6">
          ...
          {[
            ...
            <div key={i} className="flex gap-3 relative">
              {i < 3 && (
                <div
                  className={`absolute left-3 top-6 w-0.5 h-7 ${step.done ? "bg-navy/50" : "bg-blue-100"}`}
                />
              )}
              <div
                className={`w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 ${step.done ? "gradient-orange shadow-navy-sm" : "bg-blue-50 border border-blue-200"}`}
              >
                {step.done ? (
              ...
              <div className="pb-5 flex-1">
                <div
                  className={`text-sm font-heading font-semibold leading-tight ${step.done ? "text-charcoal" : "text-graphite/40"}`}
                >
                  {step.label}
                </div>
                {step.done && (
                  <div className="text-[11px] text-graphite font-body">
                    {step.time} · {step.loc}
                  </div>
                )}
              </div>
      ...
      <div className="relative w-full h-full flex items-center justify-center">
        <div className="w-72 md:w-80 bg-white rounded-2xl shadow-lg border border-blue-100 p-6">
          ...
          <div className="grid grid-cols-4 gap-2 mb-4">
            {[
              ...
              >
                ...
                <div className="text-[8px] font-body text-graphite truncate leading-tight">
                  {city}
                </div>
              </motion.div>
            ))}
          ...
          <div className="bg-gradient-to-r from-blue-50 to-yellow-50 border border-blue-200 rounded-xl p-3 text-center">
            ...
            <span className="text-graphite text-xs font-body ml-2">
              cities connected
            </span>
          </div>
        </div>
      ...
      <div className="relative w-full h-full flex items-center justify-center">
        <div className="w-72 md:w-80 bg-white rounded-2xl shadow-lg border border-blue-100 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-[11px] text-green-600 bg-green-50 px-2 py-0.5 rounded-full border border-green-200">
              Connected
            </span>
          </div>
          {[
          ...
          <div className="mt-4 pt-3 border-t border-blue-100 flex gap-2">
            {[
              ...
              <div
                ...
                className="flex-1 bg-blue-50 border border-blue-100 rounded-lg py-2 text-center"
              >
                <div className="text-navy font-bold font-heading text-xs">
                  {v}
                </div>
                <div className="text-graphite text-[10px] font-body">{l}</div>
              </div>
        ...
        >
          <div className="text-[10px] text-graphite font-body">
            Orders today
          </div>
...
export default function ScrollCarousel() {
  ...
  const handleScroll = useCallback(() => {
    ...
    setProgress(raw);
    setActiveIndex(
      Math.min(SLIDES.length - 1, Math.floor(raw * SLIDES.length)),
    );
  }, []);
    ...
    <section className="bg-white">
      ...
      <div className="container-custom pt-20 pb-4 text-center">
        ...
        <p className="text-graphite font-body max-w-xl mx-auto text-base">
          Scroll to explore what makes VEXARO the courier partner of choice for
      ...
      <div ref={trackRef} style={{ height: "250vh" }} className="relative">
        ...
        <div className="sticky top-0 h-screen overflow-hidden">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle at 1px 1px, #E06000 1px, transparent 0)",
                    ...
                    {slide.bullets.map((b, i) => (
                      ...
                      >
                        <div
                          ...
                          style={{
                            background: `linear-gradient(135deg, ${slide.accentColor}, #E8C84A)`,
                          }}
                        >
                ...
                {SLIDES.map((s, i) => (
                  <motion.div
                    ...
                    animate={{
                      ...
                      opacity:
                        i === activeIndex ? 1 : i < activeIndex ? 0.55 : 0.25,
                    }}
